...
/**
 * BorderGlow — adapted from React Bits BorderGlow-TS-TW
 * Source: https://reactbits.dev/r/BorderGlow-TS-TW.json (via the React Bits MCP registry)
 * Changes: 'use client' for Next.js, explicit `import React` for the React.* namespace types.
 * Renders a card with a glowing mesh-gradient border that follows the cursor and
 * intensifies near the edges. Requires a solid `backgroundColor`.
 */
