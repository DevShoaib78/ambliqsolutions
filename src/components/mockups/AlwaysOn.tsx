  ...
  return (
    <div className="flex items-center justify-center w-full h-40 bg-navy-900 rounded-xl overflow-hidden">
      <svg viewBox="0 0 160 140" width="160" height="140" aria-hidden="true">
        {/* Clock face */}
        <circle cx="72" cy="68" r="50" fill="none" stroke="#0C60FC" strokeWidth="4" opacity="0.3" />
        <circle cx="72" cy="68" r="44" fill="none" stroke="#0C60FC" strokeWidth="2" />
        {/* Hour hand */}
        <line x1="72" y1="68" x2="72" y2="36" stroke="#fff" strokeWidth="3" strokeLinecap="round" />
        {/* Minute hand */}
